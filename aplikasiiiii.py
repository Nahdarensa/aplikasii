...
def main():
    ...
    # CSS untuk gradasi warna pastel colorful yang cerah dan animasi bergerak
    background_color_start = "#FFB6C1"  # Light Pink
    background_color_end = "#B0E0E6"  # Powder Blue
    font_size = "22px"  # Ukuran font untuk teks biasa
    header_font_size = "40px"  # Ukuran font untuk header
    subheader_font_size = "18px"  # Ukuran font untuk subheader
    st.markdown(f"""
        <style>
        .stApp {{
    ...
    # Tentang Aplikasi
    st.header("")
    img_url = "https://imgur.com/a/8DGLEI1" 
